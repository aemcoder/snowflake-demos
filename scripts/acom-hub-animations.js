 ...
 * nav-scroll state, then the 8 project scripts in source-declared order.
 *
 ...
 *
 * NOTE: reveal-tuner.js is intentionally NOT bundled. It was a dev-time
 * UI for adjusting scroll-reveal timings (injects a "Timeline controls"
 * panel into the DOM). Visible in production renders → cosmetic
 * regression vs. the source's intended hidden default state.
 */
