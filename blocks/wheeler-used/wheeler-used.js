...
const TEMPLATE = `<div class="wrap">
  <div class="sec-head">
    <div data-field>
      ...
      <p>Inspected, serviced, and backed by Wheeler. Browse machines ready to work &mdash; financing and Cat&reg; Customer Value Agreements available.</p>
    </div>
  ...
  <div class="cards">
    <a href="#" class="card" data-repeat>
      ...
      <div class="body">
        <h3 data-slot>2021 Cat&reg; 320 Hydraulic Excavator</h3>
        <div class="specs">
