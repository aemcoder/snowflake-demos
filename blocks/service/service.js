...
<section class="service">
  <div class="wrap">
    <div class="grid">
      ...
      <div class="gallery">
        <img data-field class="g1" style="position:absolute;box-shadow:0 24px 50px rgba(0,0,0,.18);border:6px solid #fff;top:0;left:0;width:74%;height:300px;object-fit:cover;z-index:1;">
        <img data-field class="g2" style="position:absolute;box-shadow:0 24px 50px rgba(0,0,0,.18);border:6px solid #fff;bottom:0;right:0;width:60%;height:280px;object-fit:cover;z-index:2;">
        <div class="badge-yrs">
