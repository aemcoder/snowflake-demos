...
<div class="hero-inner">
  <img data-field alt="" class="hero-bg">
  <div class="scrim"></div>
  <div class="wrap">
    <div class="promo-ribbon reveal">
      <span class="tag" data-field>Demo Days '26</span>
      <a href="#" class="body" data-field><b>June 11–12 · Salt Lake City</b> — Hands-on demos of the full Cat® lineup. <span class="go">Details <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M13 6l6 6-6 6"/></svg></span></a>
    </div>
    ...
    <div class="cta-row">
      <a href="#" class="btn btn-y" data-field>Shop Used Equipment <svg viewBox="0 0 24 24"><path d="M5 12h14M13 6l6 6-6 6"/></svg></a>
